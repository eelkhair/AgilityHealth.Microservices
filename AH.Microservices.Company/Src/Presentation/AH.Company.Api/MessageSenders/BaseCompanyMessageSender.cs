...
namespace AH.Company.Api.MessageSenders;
...
public abstract class BaseCompanyMessageSender
{
    /// <summary>
    ...
    protected BaseCompanyMessageSender(IMessageSender sender, ILogger logger, IMediator mediator, IMapper mapper)
    {

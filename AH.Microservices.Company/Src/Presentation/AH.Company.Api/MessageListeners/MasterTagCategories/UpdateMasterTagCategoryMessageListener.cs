...
/// </summary>
public class UpdateMasterTagCategoryMessageListener : BaseMessageListener
{
    /// <summary>
    /// Constructor
    /// </summary>
    ...
    public UpdateMasterTagCategoryMessageListener(IMapper mapper, ILogger logger, IMediator mediator) : base(mapper, logger, mediator)
    {
    }

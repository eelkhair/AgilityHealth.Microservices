...
var swaggerConfig = new SwaggerDocSetup("AgilityHealth Metadata Api", "ah-metadata", PermissionDefinitions.GetPermissions(), xmlPath);
...
builder.SetupTracing("ah-metadata");
